...
(CKEDITOR.env.ie&&7>=CKEDITOR.env.version?"dialogs/wsc_ie.js":window.postMessage?"dialogs/wsc.js":"dialogs/wsc_ie.js"))}});CKEDITOR.plugins.add("imagepaste",{init:function(c){c.on("paste",function(b){var a=b.data;if(a=a.html||a.type&&"html"==a.type&&a.dataValue)CKEDITOR.env.webkit&&0<a.indexOf("webkit-fake-url")&&(alert("Sorry, the images pasted with Safari aren't usable"),window.open("https://bugs.webkit.org/show_bug.cgi?id=49141"),a=a.replace(/<img src="webkit-fake-url:.*?">/g,"")),a=a.replace(/<img src="data:image\/png;base64,.*?" alt="">/g,function(a){var b=a.match(/"data:image\/png;base64,(.*?)"/)[1],f=CKEDITOR.tools.getNextId(),
d=new XMLHttpRequest;d.open("POST",c.config.filebrowserImageUploadUrl+"&CKEditor="+c.name+"&CKEditorFuncNum=2&langCode="+c.langCode);d.onload=function(){var a=d.responseText.match(/2,\s*'(.*?)',/)[1],b=c.document.getById(f);b.data("cke-saved-src",a);b.setAttribute("src",a);b.removeAttribute("id")};var e;e='-----------------------------1966284435497298061834782736\r\nContent-Disposition: form-data; name="upload"';b=window.atob(b);e=e+('; filename="'+f+'.png"\r\nContent-type: image/png')+("\r\n\r\n"+
b+"\r\n-----------------------------1966284435497298061834782736")+"--";d.setRequestHeader("Content-Type","multipart/form-data; boundary=---------------------------1966284435497298061834782736");d.sendAsBinary(e);return a.replace(/>/,' id="'+f+'">')}),b.data.html?b.data.html=a:b.data.dataValue=a})}});CKEDITOR.plugins.add("texttransform",{lang:"en,tr",init:function(a){var c=0;a.addCommand("transformTextSwitch",{exec:function(){var b=a.getSelection(),d=["transformTextToUppercase","transformTextToLowercase","transformTextCapitalize"];0<b.getSelectedText().length&&(b.lock(),a.execCommand(d[c]),b.unlock(!0),c<d.length-1?c++:c=0)}});a.addCommand("transformTextToUppercase",{exec:function(){var b=a.getSelection();0<b.getSelectedText().length&&("tr"==a.langCode?a.insertHtml(b.getSelectedText().trToUpperCase()):
a.insertHtml(b.getSelectedText().toUpperCase()))}});a.addCommand("transformTextToLowercase",{exec:function(){var b=a.getSelection();0<b.getSelectedText().length&&("tr"==a.langCode?a.insertHtml(b.getSelectedText().trToLowerCase()):a.insertHtml(b.getSelectedText().toLowerCase()))}});a.addCommand("transformTextCapitalize",{exec:function(){var b=a.getSelection();0<b.getSelectedText().length&&(b="tr"==a.langCode?b.getSelectedText().replace(/\w\S*/g,function(a){return a.charAt(0).trToUpperCase()+a.substr(1).trToLowerCase()}):
b.getSelectedText().replace(/\w\S*/g,function(a){return a.charAt(0).toUpperCase()+a.substr(1).toLowerCase()}),a.insertHtml(b))}});a.ui.addButton("TransformTextSwitcher",{label:a.lang.texttransform.transformTextSwitchLabel,command:"transformTextSwitch",icon:this.path+"images/transformSwitcher.png"});a.ui.addButton("TransformTextToLowercase",{label:a.lang.texttransform.transformTextToLowercaseLabel,command:"transformTextToLowercase",icon:this.path+"images/transformToLower.png"});a.ui.addButton("TransformTextToUppercase",
{label:a.lang.texttransform.transformTextToUppercaseLabel,command:"transformTextToUppercase",icon:this.path+"images/transformToUpper.png"});a.ui.addButton("TransformTextCapitalize",{label:a.lang.texttransform.transformTextCapitalizeLabel,command:"transformTextCapitalize",icon:this.path+"images/transformCapitalize.png"})}});(function(){var b={readOnly:1,exec:function(a){if(a.fire("save")&&(a=a.element.$.form))try{a.submit()}catch(b){a.submit.click&&a.submit.click()}}};CKEDITOR.plugins.add("allowsave",{init:function(a){a.addCommand("save",b).modes={wysiwyg:1,source:1};a.ui.addButton&&a.ui.addButton("Save",{label:a.lang.allowsave.toolbar,command:"save",toolbar:"document,10"})}})})();(function(){function j(a){var b=null!=a.config.autosave_SaveKey?a.config.autosave_SaveKey:"autosave_"+window.location,d=null!=a.config.autosave_NotOlderThan?a.config.autosave_NotOlderThan:1440,c=null!=a.config.autosave_saveOnDestroy?a.config.autosave_saveOnDestroy:!1,e=null!=a.config.autosave_saveDetectionSelectors?a.config.autosave_saveDetectionSelectors:"a[href^='javascript:__doPostBack'][id*='Save'],a[id*='Cancel']";CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("autosave")+
"js/extensions.min.js"),function(){n(a,b);if(localStorage.getItem(b)){var f=h(b),c=f.data,f=f.saveTime;a.getData()==c?localStorage.removeItem(b):moment(new Date).diff(f,"minutes")>d?g(b):(c=a.lang.autosave.loadSavedContent.replace("{0}",moment(f).lang(a.config.language).format(a.lang.autosave.dateFormat)),confirm(c)?a.openDialog("autosaveDialog"):g(b))}});jQuery(e).click(function(){g(b)});a.on("change",k);a.on("destroy",function(){c&&l(b,a)});a.on("uiSpace",function(a){"bottom"==a.data.space&&(a.data.html+=
'<div class="autoSaveMessage" unselectable="on"><div unselectable="on" id="cke_autoSaveMessage_'+a.editor.name+'"class="hidden">'+a.editor.lang.autosave.autoSaveMessage+"</div></div>")},a,null,100)}function n(a,b){CKEDITOR.dialog.add("autosaveDialog",function(){return{title:a.lang.autosave.title,minHeight:155,height:300,width:750,onShow:function(){m(this,a,b)},onOk:function(){var d=h(b);a.setData(d.data);g(b)},onCancel:function(){g(b)},contents:[{label:"",id:"general",elements:[{type:"radio",id:"diffType",
label:a.lang.autosave.diffType,items:[[a.lang.autosave.sideBySide,"sideBySide"],[a.lang.autosave.inline,"inline"]],"default":"sideBySide",onClick:function(){m(this._.dialog,a,b)}},{type:"html",id:"diffContent",html:""}]}],buttons:[{id:"ok",type:"button",label:a.lang.autosave.ok,"class":"cke_dialog_ui_button_ok cke_dialog_autosave_ok",onClick:function(a){a=a.data.dialog;!1!==a.fire("ok",{hide:!0}).hide&&a.hide()}},{id:"cancel",type:"button",label:a.lang.autosave.no,"class":"cke_dialog_ui_button_cancel",
onClick:function(a){a=a.data.dialog;!1!==a.fire("cancel",{hide:!0}).hide&&a.hide()}}]}})}function h(a){a=LZString.decompressFromUTF16(localStorage.getItem(a));return JSON.parse(a)}function l(a,b){var d=LZString.compressToUTF16(JSON.stringify({data:b.getData(),saveTime:new Date}));localStorage.setItem(a,d);var c=document.getElementById("cke_autoSaveMessage_"+b.name);c&&(c.className="show",setTimeout(function(){c.className="hidden"},2E3))}function g(a){e&&clearTimeout(e);localStorage.removeItem(a)}
function m(a,b,d){var d=h(d),c=difflib.stringAsLines(b.getData()),e=difflib.stringAsLines(d.data),f=(new difflib.SequenceMatcher(c,e)).get_opcodes();a.getContentElement("general","diffContent").getElement().setHtml('<div class="diffContent">'+diffview.buildView({baseTextLines:c,newTextLines:e,opcodes:f,baseTextName:b.lang.autosave.loadedContent,newTextName:b.lang.autosave.autoSavedContent+moment(d.saveTime).lang(b.config.language).format(b.lang.autosave.dateFormat)+"'",contextSize:3,viewType:"inline"==
a.getContentElement("general","diffType").getValue()?1:0}).outerHTML+"</div>")}if(function(){if("undefined"===typeof Storage)return!1;try{return localStorage.getItem("___test_key"),!0}catch(a){return!1}}()){CKEDITOR.plugins.add("autosave",{version:0.1,init:function(a){CKEDITOR.document.appendStyleSheet(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("autosave")+"css/autosave.min.css"));"undefined"===typeof jQuery?CKEDITOR.scriptLoader.load("//ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js",function(){jQuery.noConflict();
j(a)}):CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("autosave")+"js/extensions.min.js"),function(){j(a)})}});var e=0,i=!1,k=function(a){e&&clearTimeout(e);e=setTimeout(o,1E3*(null!=CKEDITOR.config.autosave_delay?CKEDITOR.config.autosave_delay:10),a)},o=function(a){if(i)k(a);else if(a.editor.checkDirty()||a.editor.plugins.bbcode)i=!0,a=a.editor,l(null!=a.config.autosave_SaveKey?a.config.autosave_SaveKey:"autosave_"+window.location,a),i=!1}}else CKEDITOR.plugins.add("autosave",
{})})();CKEDITOR.plugins.add("glyphicons",{icons:"glyphicons",init:function(a){a.addCommand("glyphiconsDialog",new CKEDITOR.dialogCommand("glyphiconsDialog"));a.ui.addButton("Glyphicons",{label:"Insert Glyphicons",command:"glyphiconsDialog",toolbar:"document"});CKEDITOR.dialog.add("glyphiconsDialog",this.path+"dialogs/glyphicons.js")}});CKEDITOR.plugins.add("stat",{lang:"en,ru,fr",init:function(b){function n(){var a="";if("wysiwyg"==b.mode)a=(a=b.getSelection())&&a.getType()==CKEDITOR.SELECTION_TEXT&&null!==a.getSelectedText()?i(a.getSelectedText(),"nospace"):"";else if(window["codemirror_"+b.id])a=window["codemirror_"+b.id].getSelection();else{a=b.textarea.$;if(document.selection){var d=document.selection.createRange().getBookmark(),c=a.createTextRange();c.moveToBookmark(d);d=a.createTextRange();d.collapse(!0);d.setEndPoint("EndToStart",
...
b.document.on("mousedown",function(){f=!0});b.document.on("mouseup",function(){f=!1})});b.on("selectionChange",h);b.on("key",g);b.on("afterCommandExec",g);b.on("dialogHide",g)}});CKEDITOR.config.plugins='dialogui,dialog,about,a11yhelp,dialogadvtab,basicstyles,bidi,blockquote,clipboard,button,panelbutton,panel,floatpanel,colorbutton,colordialog,templates,menu,contextmenu,div,resize,toolbar,elementspath,enterkey,entities,popup,filebrowser,find,fakeobjects,flash,floatingspace,listblock,richcombo,font,forms,format,horizontalrule,htmlwriter,iframe,wysiwygarea,image,indent,indentblock,indentlist,smiley,justify,menubutton,language,link,list,liststyle,magicline,maximize,newpage,pagebreak,pastetext,pastefromword,preview,print,removeformat,save,selectall,showblocks,showborders,sourcearea,specialchar,scayt,stylescombo,tab,table,tabletools,undo,wsc,imagepaste,texttransform,allowsave,autosave,glyphicons,stat';CKEDITOR.config.skin='moono';(function() {var setIcons = function(icons, strip) {var path = CKEDITOR.getUrl( 'plugins/' + strip );icons = icons.split( ',' );for ( var i = 0; i < icons.length; i++ )CKEDITOR.skin.icons[ icons[ i ] ] = { path: path, offset: -icons[ ++i ], bgsize : icons[ ++i ] };};if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,bidiltr,168,,bidirtl,192,,blockquote,216,,copy-rtl,240,,copy,264,,cut-rtl,288,,cut,312,,paste-rtl,336,,paste,360,,bgcolor,384,,textcolor,408,,templates-rtl,432,,templates,456,,creatediv,480,,find-rtl,504,,find,528,,replace,552,,flash,576,,button,600,,checkbox,624,,form,648,,hiddenfield,672,,imagebutton,696,,radio,720,,select-rtl,744,,select,768,,textarea-rtl,792,,textarea,816,,textfield-rtl,840,,textfield,864,,horizontalrule,888,,iframe,912,,image,936,,indent-rtl,960,,indent,984,,outdent-rtl,1008,,outdent,1032,,smiley,1056,,justifyblock,1080,,justifycenter,1104,,justifyleft,1128,,justifyright,1152,,language,1176,,anchor-rtl,1200,,anchor,1224,,link,1248,,unlink,1272,,bulletedlist-rtl,1296,,bulletedlist,1320,,numberedlist-rtl,1344,,numberedlist,1368,,maximize,1392,,newpage-rtl,1416,,newpage,1440,,pagebreak-rtl,1464,,pagebreak,1488,,pastetext-rtl,1512,,pastetext,1536,,pastefromword-rtl,1560,,pastefromword,1584,,preview-rtl,1608,,preview,1632,,print,1656,,removeformat,1680,,save,1704,,selectall,1728,,showblocks-rtl,1752,,showblocks,1776,,source-rtl,1800,,source,1824,,specialchar,1848,,scayt,1872,,table,1896,,redo-rtl,1920,,redo,1944,,undo-rtl,1968,,undo,1992,,spellchecker,2016,,glyphicons,4080,auto','icons_hidpi.png');else setIcons('about,0,auto,bold,33,auto,italic,66,auto,strike,99,auto,subscript,132,auto,superscript,165,auto,underline,198,auto,bidiltr,231,auto,bidirtl,264,auto,blockquote,297,auto,copy-rtl,330,auto,copy,363,auto,cut-rtl,396,auto,cut,429,auto,paste-rtl,462,auto,paste,495,auto,bgcolor,528,auto,textcolor,561,auto,templates-rtl,594,auto,templates,627,auto,creatediv,660,auto,find-rtl,693,auto,find,726,auto,replace,759,auto,flash,792,auto,button,825,auto,checkbox,858,auto,form,891,auto,hiddenfield,924,auto,imagebutton,957,auto,radio,990,auto,select-rtl,1023,auto,select,1056,auto,textarea-rtl,1089,auto,textarea,1122,auto,textfield-rtl,1155,auto,textfield,1188,auto,horizontalrule,1221,auto,iframe,1254,auto,image,1287,auto,indent-rtl,1320,auto,indent,1353,auto,outdent-rtl,1386,auto,outdent,1419,auto,smiley,1452,auto,justifyblock,1485,auto,justifycenter,1518,auto,justifyleft,1551,auto,justifyright,1584,auto,language,1617,auto,anchor-rtl,1650,auto,anchor,1683,auto,link,1716,auto,unlink,1749,auto,bulletedlist-rtl,1782,auto,bulletedlist,1815,auto,numberedlist-rtl,1848,auto,numberedlist,1881,auto,maximize,1914,auto,newpage-rtl,1947,auto,newpage,1980,auto,pagebreak-rtl,2013,auto,pagebreak,2046,auto,pastetext-rtl,2079,auto,pastetext,2112,auto,pastefromword-rtl,2145,auto,pastefromword,2178,auto,preview-rtl,2211,auto,preview,2244,auto,print,2277,auto,removeformat,2310,auto,save,2343,auto,selectall,2376,auto,showblocks-rtl,2409,auto,showblocks,2442,auto,source-rtl,2475,auto,source,2508,auto,specialchar,2541,auto,scayt,2574,auto,table,2607,auto,redo-rtl,2640,auto,redo,2673,auto,undo-rtl,2706,auto,undo,2739,auto,spellchecker,2772,auto,glyphicons,2805,auto','icons.png');})();CKEDITOR.lang.languages={"en":1};}());
/* ========================================================================
